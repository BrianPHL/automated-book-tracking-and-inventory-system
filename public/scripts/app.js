...
import personnelTableRoute from "./routes/personnel/table.route.js";
import personnelModalRoute from "./routes/personnel/modal.route.js";
...
app.use("/personnel/table", personnelTableRoute);
app.use("/personnel/modal", personnelModalRoute);
